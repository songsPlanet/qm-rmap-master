...
var PopupPanel = function PopupPanel(props) {
          ...
          while (1) switch (_context8.prev = _context8.next) {
            case 0:
              ...
              params = {
                ...
                CQL_FILTER: _concatInstanceProperty(_context3 = "INTERSECTS(the_geom,Point(".concat(e.lngLat.lng, " ")).call(_context3, e.lngLat.lat, "))")
              };
              ...
              _loop = /*#__PURE__*/_regeneratorRuntime.mark(function _loop(i) {
                ...
                return _regeneratorRuntime.wrap(function _loop$(_context7) {
                  while (1) switch (_context7.prev = _context7.next) {
                    case 0:
                      _context7.next = 2;
                      return axios.get(url, _objectSpread(_objectSpread({}, params), {}, {
  ...
  return jsx("div", {
    children: popupData ? jsx(PopupWrapper, {
