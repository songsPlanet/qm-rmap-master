import LayerGroupWrapper from '@/gis/wrapper/LayerGroupWrapper';
import { memo, useCallback, useEffect, useState } from 'react';
import LayerWrapper from '@/gis/wrapper/LayerWrapper';
              ...
              {items?.map((d) => {
                ...
                return (
                  <div className="mapboxgl-legend-item" key={d.text}>
                    {img ? (
                      <img src={img.url} alt="" className="mapboxgl-legend-item-img" />
                    ) : (
