...
exports.downLoadFile = exports.events = exports.useReducer = exports.request = void 0;
...
Object.defineProperty(exports, 'request', {
  enumerable: true,
  get: function () {
    return __importDefault(axios_1).default;
  },
});
var useReducer_1 = require('./useReducer');
Object.defineProperty(exports, 'useReducer', {
  enumerable: true,
  get: function () {
    return __importDefault(useReducer_1).default;
  },
});
 ...
 * @param extName  文件后缀
 */
function downloadFile(fileName, data, extName = '.xlsx') {
 ...
 * @returns
 */
function debounce(func, delay, immediately = false) {
  let interval = null;
 ...
 * @returns
 */
function throttle(func, delay, immediately = false) {
  let interval = null;
  return function (...args) {
    if (immediately) {
      if (interval) return;
 ...
 */
function scrollToPosition(position, timingFunction = 'linear', times = 50, container = document.documentElement) {
  execAnimation(0);
  function execAnimation(count) {
    const scrollTop = container.scrollTop;
    let pos = tween_1.default[timingFunction](count, scrollTop, position - scrollTop, times);
 ...
 * @returns
 */
function toFixed(value, divisor = 10000, float = 2) {
  if (!value) return '';
  return (value / divisor).toFixed(float);
}
