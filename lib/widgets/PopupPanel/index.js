...
var PopupPanel = function PopupPanel(props) {
      ...
      if (vector) {
        ...
        if (features.length) {
          ...
          setPopupData({
            ...
            lngLat: map.unproject(new _mapboxGl.Point(e.point.x / scale, e.point.y / scale)),
            title: title,
            template: template
          });
        }
          ...
          while (1) switch (_context8.prev = _context8.next) {
            case 0:
              ...
              params = {
                ...
                CQL_FILTER: (0, _concat.default)(_context3 = "INTERSECTS(smgeometry,Point(".concat(e.lngLat.lng / scale, " ")).call(_context3, e.lngLat.lat / scale, "))")
              };
  ...
  return (0, _jsxRuntime.jsx)("div", {
    children: popupData && map ? (0, _jsxRuntime.jsx)(_index.default, {
      map: map,
