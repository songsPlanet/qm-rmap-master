 ...
 * @returns {{}}
 */
(0, _defineProperty2.default)(GisToolHelper, "createPolygonFeatureCollection", function (coords) {
  return {
 ...
 * @returns {{}}
 */
(0, _defineProperty2.default)(GisToolHelper, "createPointFeatureCollection", function (lonlat) {
  return {
    type: 'FeatureCollection',
    features: [{
      type: 'Feature',
 ...
 * @returns {{}}
 */
(0, _defineProperty2.default)(GisToolHelper, "createLineFeatureCollection", function (coords) {
  return {
    type: 'FeatureCollection',
    features: [{
      type: 'Feature',
